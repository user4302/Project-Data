...
### Fixed
- Added intelligent GitLab branch detection and switching logic
- Fixed "src refspec main does not match any" error with dynamic branch handling
- Added fallback support for both main and master branch naming conventions
- Enhanced workflow with branch debugging information

## [1.0.3] - 2025-06-17

### Fixed
- Added Git user identity configuration to GitLab portfolio update step
- Fixed "Author identity unknown" error preventing GitLab pushes
- Ensured proper git config before committing changes to GitLab repository
